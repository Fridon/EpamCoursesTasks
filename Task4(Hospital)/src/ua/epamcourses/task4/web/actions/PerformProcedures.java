...
public class PerformProcedures implements Action{
	private static final Logger log = Logger.getLogger(PerformProcedures.class);
	@Override
	public String doAction(HttpServletRequest request,
		...
		if(!PPS.deletePatientProcedures(patient, procedure))
